 ...
 */
public enum SituacaoStatusEnum implements IIntegerEnum, II18nEnum
{
	 ...
	 */
	private SituacaoStatusEnum(Integer value, String labelKeyParam)
	{
		code = value;
	 ...
	 */
	public static SituacaoStatusEnum enumForValue(Integer value)
	{
		for (SituacaoStatusEnum e : values())
		{
	...
	public static String getValidValues()
	{
		...
		for (SituacaoStatusEnum i : SituacaoStatusEnum.class.getEnumConstants())
		{
