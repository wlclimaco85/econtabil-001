 ...
 */
public enum EmpresaTypeEnum implements IIntegerEnum, II18nEnum
{
	...
	MATRIX(5, "com.prosperitasglobal.sendsolv.model.payrolltype.centralized"),

	FILIAL(6, "com.prosperitasglobal.sendsolv.model.payrolltype.centralized");
	 ...
	 */
	private EmpresaTypeEnum(Integer value, String labelKeyParam)
	{
		code = value;
	 ...
	 */
	public static EmpresaTypeEnum enumForValue(Integer value)
	{
		for (EmpresaTypeEnum e : values())
		{
	...
	public static String getValidValues()
	{
		...
		for (EmpresaTypeEnum i : EmpresaTypeEnum.class.getEnumConstants())
		{
