 ...
 */
public enum NotificationTypeEnum implements IIntegerEnum, II18nEnum
{
	 ...
	 */
	private NotificationTypeEnum(Integer value, String labelKeyParam)
	{
		code = value;
	...
	public static String getValidValues()
	{
		...
		for (NotificationTypeEnum i : NotificationTypeEnum.class.getEnumConstants())
		{
