...
public class NFNotaInfoItemImpostoICMSSN202 extends ModelCosmeDamiao {

	/** The econtabil id for the NFNotaInfoItemImpostoICMSSN202. */
	private Integer id;

	/** The econtabil origem for the NFNotaInfoItemImpostoICMSSN202. */
	private DoisValores origem;

	/**
	 * The econtabil situacaoOperacaoSN for the NFNotaInfoItemImpostoICMSSN202.
	 */
	private DoisValores situacaoOperacaoSN;

	/**
	 * The econtabil modalidadeBCICMSST for the NFNotaInfoItemImpostoICMSSN202.
	 */
	...
	/** The econtabil valorBCICMSST for the NFNotaInfoItemImpostoICMSSN202. */
	...
	/** The econtabil valorICMSST for the NFNotaInfoItemImpostoICMSSN202. */
	private String valorICMSST;

	/**
	 * Default constructor.
	 */
	public NFNotaInfoItemImpostoICMSSN202() {
		super();
	}
	...
	public String toString() {
		return "NFNotaInfoItemImpostoICMSSN202 [getId()=" + getId() + ", getOrigem()=" + getOrigem()
