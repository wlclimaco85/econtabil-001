...
public class NFNotaInfoItemImpostoPISNaoTributado extends ModelCosmeDamiao {

	/** The econtabil id for the NFNotaInfoItemImpostoPISNaoTributado. */
	private Integer id;
	...
	public String toString() {
		return "NFNotaInfoItemImpostoPISNaoTributado [getId()=" + getId() + ", getSituacaoTributaria()="
