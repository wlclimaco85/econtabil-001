...
public class NFNotaInfoItemImpostoICMS70 extends ModelCosmeDamiao {

	/** The econtabil id for the NFNotaInfoItemImpostoICMS70. */
	private Integer id;

	/** The econtabil origem for the NFNotaInfoItemImpostoICMS70. */
	private DoisValores origem;

	/** The econtabil situacaoTributaria for the NFNotaInfoItemImpostoICMS70. */
	private DoisValores situacaoTributaria;

	/** The econtabil modalidadeBCICMS for the NFNotaInfoItemImpostoICMS70. */
	private DoisValores modalidadeBCICMS;

	/**
	 * The econtabil percentualReducaoBC for the NFNotaInfoItemImpostoICMS70.
	 */
	private String percentualReducaoBC;

	/** The econtabil valorBC for the NFNotaInfoItemImpostoICMS70. */
	private String valorBC;

	/** The econtabil percentualAliquota for the NFNotaInfoItemImpostoICMS70. */
	private String percentualAliquota;

	/** The econtabil valorTributo for the NFNotaInfoItemImpostoICMS70. */
	...
	/** The econtabil valorBCST for the NFNotaInfoItemImpostoICMS70. */
	...
	/** The econtabil valorICMSST for the NFNotaInfoItemImpostoICMS70. */
	private String valorICMSST;

	/**
	 * The econtabil valorICMSDesoneracao for the NFNotaInfoItemImpostoICMS70.
	 */
	 ...
	 * Default constructor.
	 */
	public NFNotaInfoItemImpostoICMS70() {
		super();
	}
	...
	public String toString() {
		return "NFNotaInfoItemImpostoICMS70 [getId()=" + getId() + ", getOrigem()=" + getOrigem()
				+ ", getSituacaoTributaria()=" + getSituacaoTributaria() + ", getModalidadeBCICMS()="
				+ getModalidadeBCICMS() + ", getPercentualReducaoBC()=" + getPercentualReducaoBC() + ", getValorBC()="
				+ getValorBC() + ", getPercentualAliquota()=" + getPercentualAliquota() + ", getValorTributo()="
				+ getValorTributo() + ", getModalidadeBCICMSST()=" + getModalidadeBCICMSST()
