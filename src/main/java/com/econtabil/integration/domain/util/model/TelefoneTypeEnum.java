 ...
 *
 */
public enum TelefoneTypeEnum implements IIntegerEnum, II18nEnum
{
	...
	EMPRESA(9, "com.prosperitasglobal.sendsolv.model.payrolltype.unknown"),

	CELULAR(10, "com.prosperitasglobal.sendsolv.model.payrolltype.unknown");
	 ...
	 */
	private TelefoneTypeEnum(Integer value, String labelKeyParam)
	{
		code = value;
	 ...
	 */
	public static TelefoneTypeEnum enumForValue(Integer value)
	{
		for (TelefoneTypeEnum e : values())
		{
	...
	public static String getValidValues()
	{
		...
		for (TelefoneTypeEnum i : TelefoneTypeEnum.class.getEnumConstants())
		{
