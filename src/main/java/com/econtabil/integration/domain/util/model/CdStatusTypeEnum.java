...
public enum CdStatusTypeEnum implements IIntegerEnum, II18nEnum
{
	...
	NEGATIVADO(5, "com.prosperitasglobal.sendsolv.model.payrolltype.not_centralized"),

	ANALISANDO(6, "com.prosperitasglobal.sendsolv.model.payrolltype.not_centralized");
