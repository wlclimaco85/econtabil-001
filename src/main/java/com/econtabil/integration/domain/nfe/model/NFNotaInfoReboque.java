...
public class NFNotaInfoReboque extends NFBase
{
    ...
    /** The econtabil placaVeiculo for the NFNotaInfoReboque. */
    private String placaveiculo;

    /** The econtabil uf for the NFNotaInfoReboque. */
    private String uf;

    /** The econtabil registroNacionalTransportadorCarga for the NFNotaInfoReboque. */
...
public void setRegistroNacionalTransportadorCarga(String registronacionaltransportadorcarga)
{
	...
	public String toString() {
		return "NFNotaInfoReboque [getPlacaVeiculo()=" + getPlacaVeiculo() + ", getUf()=" + getUf()
